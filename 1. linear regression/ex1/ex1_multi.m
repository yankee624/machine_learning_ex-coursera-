...
[theta1, J_history1] = gradientDescentMulti(X, y, theta, 0.03, 100);
[theta2, J_history2] = gradientDescentMulti(X, y, theta, 0.1, 100);
[theta3, J_history3] = gradientDescentMulti(X, y, theta, 1, 100);
theta = theta3;
